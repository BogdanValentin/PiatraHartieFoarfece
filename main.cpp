...
int main()
{
    ...
    while(stopper == 'y')
    {
        ...
        if(random == 0) strcpy(cpuchoice,"piatra"); // cpuchoice primeste valoarea piatra, hartie sau foarfece dupa numarul random generat mai sus.
        else if(random == 1) strcpy(cpuchoice,"hartie");
        else if(random == 2) strcpy(cpuchoice,"foarfece");
        if(random == aux)
